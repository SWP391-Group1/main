                ...
                <form onsubmit="return checkFormRegist()" id="formLogin" action="<c:url value="/user/addDoctor"/>" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        ...
                        <select id="type" name="type"
                            ...
                            <option <c:if test="${requestScope.type eq 'DOCTOR'}">selected</c:if> value="2">Doctor</option>
                            <option <c:if test="${requestScope.type eq 'PATIENT'}">selected</c:if> value="4">Patient</option>
                            <option <c:if test="${requestScope.type eq 'RECEPTIONIST'}">selected</c:if> value="3">Receptionist</option>
                        </select>
                        <div class="form-check">
